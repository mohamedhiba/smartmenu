...
> You are in Rome, the menu is in Italian, and you are keto. Google Translate
> gives you words. It does not tell you what you can actually eat.
> SmartMenu reads the menu, translates it, estimates the nutrition, and ranks
> every dish against your diet.
...
> One photo, one model call, no typing. It works on any phone with a browser.
> Next up: allergen alerts and restaurant partnerships.

## If it breaks

Say nothing about the error. Add `?demo=1` to the URL and keep talking. If that
fails, switch to the recording without pausing. Never debug on stage.
